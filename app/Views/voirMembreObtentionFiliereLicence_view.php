...
<script>
  $(document).ready(function() {
    ...
    function rechercherUsersObtentionFiliereLI(query) {
      var idObtentionLI=<?=$idObtentionLI?>;
      $.ajax({
        method: "POST",
        url: "<?= base_url() ?>/public/user/rechercherUsersObtentionFiliereLI",
        data: {
          'query': query,
          'id': idObtentionLI
    ...
    $(document).on('click', '.pagination li', function() {
      var id = $(this).attr('id');
      getAllUsersLimitObtentionFiliereLI(id);
      $('.usersdata').html('');
      $('.pagination').html('');
      $('.total_data').html('');
    });
  ...
  function getAllUsersLimitObtentionFiliereLI(page) {
    var idObtentionLI=<?=$idObtentionLI?>;
    var idFiliereLI=<?=$idFiliereLI?>;
    $.ajax({
      method: "POST",
      url: "<?= base_url() ?>/public/user/getAllUsersLimitObtentionFiliereLI",
      data: {
        'page': page,
        'id': idObtentionLI,
        'idD': idFiliereLI
